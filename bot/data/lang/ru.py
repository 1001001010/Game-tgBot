...
##########################################################################
    ...
    succes_msg = "Ваша заявка успешно отправленна, ожидайте ее подтверждения"
    need_balance = "Недостаточно баланса"
    otklon_vivod = "Отмененно"
    vivod_mimo = "Ваша заявка на вывод была отклонена администратором\nДеньги возвращены на баланс"
    vivod_success_msg = "Ваша заявка на вывод была одобрена! Ожидайте поступления средств"
    Confirmation_msg = """
        ...
        """
    need_real_adress = "Введите действительный адресс"